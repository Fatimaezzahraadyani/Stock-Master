 ...
 pageEncoding="UTF-8"%>
  ...
  <!--<input type="text" value="<c:out value='${product.category}' />" class="form-control" name="category" id="category">-->
   ...
   <select class="form-select mt-2" aria-label="Select category" name="category" id="category">
    ...
    <option value="1" ${produit.category == '2' ? 'selected' : ''}>Electronique</option>
    <option value="2" ${produit.category == '3' ? 'selected' : ''}>Beauté</option>
    <option value="3" ${produit.category == '4' ? 'selected' : ''}>Vêtements</option>
    <option value="4" ${produit.category == '5' ? 'selected' : ''}>Alimentation</option>
</select>
</fieldset>
                    <fieldset class="form-group">
